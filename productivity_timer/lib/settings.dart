    ...
    return Container(
        child: GridView.count(
            ...
            children: <Widget>[
              ...
              Text(""),
              SettingsButton(
                  Color(0xff455A64), "-", -1, WORKTIME, updateSettings),
              TextField(
                  controller: txtWork,
                  style: textStyle,
              ...
              SettingsButton(
                  Color(0xff009688), "+", 1, WORKTIME, updateSettings),
              ...
              TextField(
                  ...
                  keyboardType: TextInputType.number),
              SettingsButton(
                  Color(0xff009688), "+", 1, SHORTBREAK, updateSettings),
              Text(
                "Long",
                style: textStyle,
              ),
              ...
              Text(""),
              SettingsButton(
                  Color(0xff455A64), "-", -1, LONGBREAK, updateSettings),
              TextField(
                  controller: txtLong,
                  style: textStyle,
                  textAlign: TextAlign.center,
                  keyboardType: TextInputType.number),
              SettingsButton(
                  Color(0xff009688), "+", 1, LONGBREAK, updateSettings),
            ],
